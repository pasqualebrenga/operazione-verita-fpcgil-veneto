...
export default function SiteHeader() {
  return (
    <header className="ov-header">
      ...
      <div className="ov-container ov-header-inner">
        <Link href="/" className="ov-brand" aria-label="FPCGIL Veneto - Operazione Verità">
          ...
          <div>
            <div className="ov-brand-title">FPCGIL Veneto</div>
  ...
  <a
    href="https://wa.me/393405614635?text=Operazione%20Verit%C3%A0%20FPCGIL%20Veneto%20-%20Ciao%2C%20vorrei%20informazioni."
